...
def check_bad_weather(conds):
    ...
    if conds['temperature'] < -15 or conds['temperature'] > 35:
        result = False
...
def index():
    if request.method == "POST":
        ...
        return render_template("result.html", start_point=start_point, end_point=end_point, start_weather=start_weather,
                               end_weather=end_weather, start_weather_conds=start_weather_conds,
